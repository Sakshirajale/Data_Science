# -*- coding: utf-8 -*-
"""
Created on Thu Aug 15 23:04:21 2024
...
univ1=pd.read_csv("C:/7-Clustering/crime_data.xlsx.xls")
univ1
a=univ1.describe()
a
#We have one column "state" which really not useful we will drop it
univ=univ1.drop(["UrbanPop"],axis=1)
univ
...
df=pd.read_csv("C:/7-Clustering/crime_data.xlsx.xls")
df.head()
...
plt.scatter(df3.Murder,df3['Assault'],color='black')
